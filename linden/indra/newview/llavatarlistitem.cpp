...
{
	mExtraInformation->setVisible(show);
	updateChildren();
}
...
void LLAvatarListItem::initChildrenWidths(LLAvatarListItem* avatar_item)
{
	...
	S32 extra_information_padding = avatar_item->mIconPermissionEditTheirs->getRect().mLeft - avatar_item->mExtraInformation->getRect().mRight;
