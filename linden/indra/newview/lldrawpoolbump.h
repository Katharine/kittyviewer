...
public:
	...
	void beginBump(LLRenderType pass = RENDER_TYPE_PASS_BUMP);
	void renderBump(LLRenderType pass = RENDER_TYPE_PASS_BUMP);
	void endBump(LLRenderType pass = RENDER_TYPE_PASS_BUMP);
